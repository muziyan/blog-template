...
<head>
    ...
    <link rel="stylesheet" href="{{asset("assert/web/css/style.css")}}">
...
<header>
    ...
    <!-- nav -->
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
                <a class="navbar-brand" href="{{route("index")}}">季七</a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <form class="form-inline my-2 my-lg-0" method="post" action="{{route("search")}}">
                        @csrf
                        <input class="form-control mr-sm-2" type="search" placeholder="Search article title" aria-label="Search" name="search_article">
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/js/bootstrap.min.js"
        ...
        crossorigin="anonymous"></script>
<script src="{{asset("assert/web/js/js.js")}}"></script>
